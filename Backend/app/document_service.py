...
class DocumentService:
    ...
    def extract_text_from_bytes(file_bytes: bytes, filename: str) -> str:
        ...
        if any(lower_name.endswith(ext) for ext in [".png", ".jpg", ".jpeg", ".webp"]):
            try:
                # ✅ Lazy-load inside the function block
                import pytesseract
            ...
            try:
                # ✅ Lazy-load PyMuPDF only when a PDF is processed
                import pymupdf
                import pytesseract
                from PIL import Image
                import io
    ...
    async def extract_fields_from_text(cls, text: str) -> DocumentExtractionResponse:
        # Keep your exact regex extraction logic here unchanged...
